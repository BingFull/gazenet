...
if __name__ == '__main__':
    ...
    for i in range(len(dir_list)):
        ...
        test_data_list = []
        rst_gaze_list = []
        test_data_path_tmp = test_data_path
        ...
        index_num = dir_list[i].split('_')[0]
        write_accuracy_csv([0, 0], rst_gaze_list, str(root_path) + '\\' + index_num + "_predict_rst.csv")
        tqdm.write('save csv to %s' % (str(root_path) + '\\' + index_num + "_predict_rst.csv"))
        fps.update()
